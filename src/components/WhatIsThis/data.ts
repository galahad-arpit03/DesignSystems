export const whatIsThisContent = {
  ...
  intro: "The DESIGN.md concept was introduced by Google Stitch. Stitch uses a plain markdown file to describe design patterns, colors, typography, spacing, components, and hands it to an AI agent so it can generate consistent UI. No Figma plugin, no JSON schema, just a markdown file the agent reads before it writes code. We built the VoltAgent/awesome-design-md repository on top of that idea. getdesign.md is the web app version of that repo. You can browse, preview, and copy any DESIGN.md file without cloning anything.",
  sections: [
    {
      id: "the-problem",
    ...
    {
      id: "structure",
      title: "The structure of a DESIGN.md file",
      content: [
    ...
    },
    {
      ...
      content: [
        ...
        "An AI agent doesn't have that shared context. DESIGN.md writes it into a file and puts it in the agent's \"head.\""
      ]
    },
    {
      id: "disclaimer",

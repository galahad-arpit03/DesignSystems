...
export const Footer = () => {
  return (
    <footer className="border-t border-[#111] py-10 px-6 md:px-8 mt-16 bg-black">
      <div className="max-w-[1400px] mx-auto flex flex-col lg:grid lg:grid-cols-[1fr_2fr_1fr] items-center gap-8 lg:gap-4 text-[11px] text-[#555]">
        {/* Left */}
